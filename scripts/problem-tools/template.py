#!/usr/bin/env python3
"""
根据 scripts/problem-tools/templates/ 目录下的模板文件，生成对应的代码文件
...
class TemplateEngine:
    ...
    def __init__(self):
        ...
        self.project_root = self.tool_dir.parent.parent
        self.template_dir = self.tool_dir / 'templates'
...
def apply_temp_cpp():
    ...
    template_path = template_engine.template_dir / 'template.cpp'
...
def select_and_apply_template():
    ...
    try:
        ...
        if selected:
            template_engine = TemplateEngine()
            template_path = template_engine.template_dir / selected
...
def main():
    ...
    if command == 'apply-cpp':
        ...
        template_engine = TemplateEngine()
        template_path = template_engine.template_dir / template_name
